#ifndef _POSE_TOOL2_HPP_
#define _POSE_TOOL2_HPP_
...
class PoseTool2 : public rviz_common::Tool
{
public:
    PoseTool2();
...
protected:
    virtual int onPoseSet2(double x, double y, double theta) = 0;

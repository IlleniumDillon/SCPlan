...
SCPMoveGoal::~SCPMoveGoal() = default;

void SCPMoveGoal::onInitialize()
{
...
void SCPMoveGoal::onPoseSet(double x, double y, double theta)
{
...
void SCPMoveGoal::updateTopic()
{
    ...
    RVIZ_COMMON_LOG_INFO_STREAM("SCPMoveGoal: updateTopic: " << topic_property_->getStdString());
}

}  // namespace scp_rviz_plugin

#include <pluginlib/class_list_macros.hpp>  // NOLINT
PLUGINLIB_EXPORT_CLASS(scp_rviz_plugin::SCPMoveGoal, rviz_common::Tool)
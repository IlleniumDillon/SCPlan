#include "NonInteractiveMove.hpp"
...
uve_rviz_plugin::NonInteractiveMove::NonInteractiveMove()
    : PoseToolBase(), qos_profile_(1)
{
    topic_property_ = new rviz_common::properties::StringProperty(
        "Topic", "noninter_move_goal",
...
uve_rviz_plugin::NonInteractiveMove::~NonInteractiveMove() = default;

void uve_rviz_plugin::NonInteractiveMove::onInitialize()
{
...
void uve_rviz_plugin::NonInteractiveMove::onPoseSet(double x, double y, double theta)
{
...
void uve_rviz_plugin::NonInteractiveMove::updateTopic()
{
    ...
    RVIZ_COMMON_LOG_INFO_STREAM("NonInteractiveMove: updateTopic: " << topic_property_->getStdString());
}

#include <pluginlib/class_list_macros.hpp>  // NOLINT
PLUGINLIB_EXPORT_CLASS(uve_rviz_plugin::NonInteractiveMove, rviz_common::Tool)

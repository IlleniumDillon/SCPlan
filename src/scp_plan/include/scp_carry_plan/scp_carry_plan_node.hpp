...
public:
    ...
    // Plan 
    rclcpp::Subscription<scp_message::msg::ScpCarryTask>::SharedPtr sub_goal_;
    rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pub_path_;
    geometry_msgs::msg::PoseStamped goal_msg_;
    nav_msgs::msg::Path path_msg_;
    // HybridAStar hybrid_astar_;
    CarryPlan carry_plan_;
...
public:
    ...
    // Plan
    void goalCallback(const scp_message::msg::ScpCarryTask::SharedPtr msg);
    // test code
    void timerCallback();
};

...
#ifndef BUZZER_SOUND_H_
#define BUZZER_SOUND_H_
...
// init done
static const float _tone_init_done_[] = {
		NOTE_C5,NOTE_E5,NOTE_G5,NOTE_B5
};
static const Buzzer_tone tone_init_done = {
		.music = _tone_init_done_,
		.size = sizeof(_tone_init_done_) / sizeof(float)
};
// low power
static const float _tone_low_power_[] = {
		NOTE_A4,NOTE_A3
};
static const Buzzer_tone tone_low_power = {
		.music = _tone_low_power_,
		.size = sizeof(_tone_low_power_) / sizeof(float)
};
// connect host
static const float _tone_connect_host_[] = {
		NOTE_C5,NOTE_E5
};
static const Buzzer_tone tone_connect_host = {
		.music = _tone_connect_host_,
		.size = sizeof(_tone_connect_host_) / sizeof(float)
};
// mag on
static const float _tone_mag_on_[] = {
		NOTE_E5,NOTE_E6
};
static const Buzzer_tone tone_mag_on = {
		.music = _tone_mag_on_,
		.size = sizeof(_tone_mag_on_) / sizeof(float)
};
// mag off
static const float _tone_mag_off_[] = {
		NOTE_E6,NOTE_E5
};
static const Buzzer_tone tone_mag_off = {
		.music = _tone_mag_off_,
		.size = sizeof(_tone_mag_off_) / sizeof(float)
};
// switch
static const float _tone_switch_[] = {
		NOTE_C6
};
static const Buzzer_tone tone_switch = {
		.music = _tone_switch_,
		.size = sizeof(_tone_switch_) / sizeof(float)
};



#endif /* BUZZER_SOUND_H_ */
